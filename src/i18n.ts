    ...
    en: {
        translation: {
            ...
            "market": {
                ...
                "price_gap": "The price gap between min/max is ₹{{gap}}. Grade quality is key.",
                "trend_up": "Prices for {{crop}} are trending upwards. Good time for liquidation.",
                "trend_stable": "Stability observed in {{crop}} prices. Monitor for next 48 hours.",
    ...
    te: {
        translation: {
            ...
            "market": {
                ...
                "price_gap": "కనిష్ట/గరిష్ట మధ్య ధర వ్యత్యాసం ₹{{gap}}. గ్రేడ్ నాణ్యత కీలకం.",
                "trend_up": "{{crop}}ల ధరలు ఊర్ధ్వ ధోరణిలో ఉన్నాయి. లిక్విడేషన్‌కు మంచి సమయం.",
                "trend_stable": "{{crop}} ధరలలో స్థిరత గమనించబడింది. తరువాయ 48 గంటలు పర్యవేక్షించండి.",
    ...
    hi: {
        translation: {
            ...
            "market": {
                ...
                "price_gap": "न्यूनतम/अधिकतम के बीच मूल्य अंतर ₹{{gap}}। गुणवत्ता महत्वपूर्ण है।",
                "trend_up": "{{crop}} की कीमतें ऊपर की ओर बढ़ रही हैं। लिक्विडेशन के लिए अच्छा समय।",
                "trend_stable": "{{crop}} की कीमतों में स्थिरता देखी गई। अगले 48 घंटे मॉनिटर करें।",
        ...
        translation: {
            ...
            "assistant": {
                ...
                "quick_queries": {
                    ...
                    "q3": "தக்காளி பிளைட் ஆரம்ப அறிகுறிகள் மற்றும் சேंद्रியल் கட்டுப்பாடு?",
            ...
            "diagnosis": {
                ...
                "tap_to_select": "மாதிரியைத் தேர்ந்தெடுக்க ट्যাप் செய்யவும்",
            ...
            "market": {
                ...
                "trend_up": "{{crop}} விலைகள் ऊ மேல்நோக்கிய போக்கில் உள்ளன। கலைப்பதற்கு நல்ல நேரம்।",
                "trend_stable": "{{crop}} விலைகளில் நிலைத்தன்மை காணப்படுகிறது. அடுத்த 48 மணிநேரத்திற்கு கண்காணிக்கவும்।",
